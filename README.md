...
- **宝箱**：场景中随机生成 2 个，按 F 启动节奏对位小游戏，成功回血 30%
- **胜负**：全灭对方阵营即胜利
...
### 最新 [0.4.0] — 2026-07-04
- 宝箱交互系统（地图生成 + 节奏对位小游戏 + 回血奖励）
- 宝箱素材替换为 Bonsaiheldin CC-BY 4.0 32×32 动画帧
- 修复死亡后 coroutine 覆盖 DEAD 状态（entity + 全部 AI 脚本）
- 每角色开箱速度参数（战士 120 / 弓箭手 160 / 巨魔无法开箱）
- 小游戏参数接入 GameConfig 统一调参
